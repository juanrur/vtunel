...
- [ ] manage multiple events in a li (15m space or time quadrant)
- [ ] put a polyfill of closed by (dialog)
...
- [ ] put something that wraps the components to do the drag and drop and save all the drag and drop logic there
- [ ] manage event repetition
